...
static void mctp_serial_frame_tx(
    const mctp_serial_t *serial,
    const mctp_serial_hdr_t *header,
	const mctp_pkt_t *packet,
...
static void mctp_serial_push_rx_data(
    mctp_serial_t *serial,
	const uint8_t byte
);
...
static void mctp_serial_packet_tx(
    ...
    const mctp_serial_hdr_t header = {
        .frame_flag = MCTP_SERIAL_FRAME_FLAG,
